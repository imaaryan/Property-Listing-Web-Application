...
const Footer = () => {
  ...
  return (
    <>
      <div className="max-w-[1440px] mx-auto footer grid gap-8 border-t border-gray-300 grid-cols-1 sm:grid-cols-3 md:grid-cols-[7fr_1fr_1fr] text-base-content px-3 py-10 md:px-4 md:py-20">
