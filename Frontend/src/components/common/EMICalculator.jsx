...
const EMICalculator = ({ isOpen, onClose, defaultPrice = 1000000 }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl w-full max-w-5xl shadow-2xl relative flex flex-col max-h-[90vh]">
        {/* Header */}
